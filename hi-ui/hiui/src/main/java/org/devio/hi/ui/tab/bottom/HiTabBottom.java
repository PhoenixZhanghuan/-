...
public class HiTabBottom extends RelativeLayout implements IHiTab<HiTabBottomInfo<?>> {
    ...
    @Override
    public void onTabSelectedChanged(int index, @Nullable @org.jetbrains.annotations.Nullable HiTabBottomInfo<?> prevInfo, @NonNull @NotNull HiTabBottomInfo<?> nextInfo) {
